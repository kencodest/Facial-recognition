...
class FaceRecognition(object):
  ...
  def predict(self, image, threshold=None):
    ...
    gray = cv2.cvtColor(new_image, cv2.COLOR_BGR2RGB)
  ...
  def fit(self, folder):
    """
    Fit the classifier from directory
    Directory must have this structire
      Person 1:
            file.jpg
            ...
            file.jpg
  ...
  def fit_from_dataframe(self, df, person_col="person", path_col="path"):
    ...
    :param person_col: dataframe column with person_id
    :param path_col: datafram column with image path
    """
